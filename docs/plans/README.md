...
2. FE must read UI specification before implementation.
3. Execute role-specific plan.
4. Escalate only when a requested change conflicts with locked MVP decisions.
